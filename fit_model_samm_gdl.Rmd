---
title: "ajustement modèles à 2 espèces sur données SAMM sur Golfe du Lion"
...
x2 <- proc.time() -  ptm
x2 # 15 minutes
save(x2, out2, file = "runwochalutier_samm.RData")
```
...
Save run.
```{r}
save(x, out, file = "runGAMsamm.RData")
```
